...
public class FeedbackTest {
    ...
    static String path = "file:///C:/Users/HP/Downloads/Devops%20CA2/index.html";
    ...
    public static void testValidSubmission() throws InterruptedException {
        ...
        driver.findElement(By.id("name")).sendKeys("Chinmay Bele");
        driver.findElement(By.id("email")).sendKeys("chinmaybele5@gmail.com");
        driver.findElement(By.id("mobile")).sendKeys("83900274200");
